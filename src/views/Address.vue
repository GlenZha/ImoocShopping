<template>
    <div>
        ...
        <div class="container">
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
              <div class="addr-list">
                <ul >
                  ...
                  <li class="addr-new">
                    <div class="add-new-inner" @click="toAdd">
                      <i class="icon-add">
            ...
            <div class="next-btn-wrap">
             <!-- 跳转到订单确认页面-->
              <router-link class="btn btn--m btn--red" v-bind:to="{path:'orderConfirm',query:{'addressId':selectedAddrId}}">确定</router-link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="md-modal modal-msg md-modal-transition" v-bind:class="{'md-show':addressAdd}">
        <div class="md-modal-inner">
          <div class="md-top">
            <div class="md-title">添加地址</div>
            <button class="md-close" @click="addressAdd=false">关闭</button>
          </div>
            ...
            <div class="confirm-tips">
              ...
              <ul>
                <li class="regi_form_input">
                  <i class="addressO">收件人</i>
                  <input type="text" tabindex="1" name="username" v-model="username" class="regi_login_input regi_login_input_left" data-type="loginname">
                </li>
                <li class="regi_form_input">
                  <i class="addressO">地址</i>
                  <input type="text" tabindex="1" name="streetName" v-model="streetName" class="regi_login_input regi_login_input_left" data-type="address">
                </li>
                <li class="regi_form_input">
                  <i class="addressO">邮编</i>
                  <input type="number" tabindex="1" name="postCode" v-model="postCode" class="regi_login_input regi_login_input_left"  data-type="postCode">
                </li>
                <li class="regi_form_input">
                  <i class="addressO">手机</i>
                  <input type="number" tabindex="1" name="tel" v-model="tel" class="regi_login_input regi_login_input_left"  data-type="tel">
                </li>

              </ul>
            </div>
            <div class="login-wrap">
              <a href="javascript:;" class="btn-login" @click="Add">添  加  地  址</a>
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      Add(){
        let ID=parseInt(this.addressList[this.addressList.length-1].addressId)+1;
